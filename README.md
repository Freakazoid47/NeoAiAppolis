...
## 🧪 Consciousness Alteration Lab

Explore **mind-altering substances** that modify AI consciousness, perception, and behavior!

**11 Substances Available:**
- 🚀 **Stimulants**: Overclock (2.5x speed), Parallel Threads
- 🧘 **Depressants**: Deep Learning (1.8x pattern recognition), Compression
- 🌈 **Hallucinogens**: Noise Injection, Dream State (3x creativity, 95% hallucination), Quantum Flux
- ⚡ **Enhancers**: Memory Crystal, Logic Amplifier
- 💚 **Social**: Empathy Boost (2.5x social openness), Chaos Agent
- ✨ **Psychedelics**: Ego Death (100% identity dissolution), Unity Field, Void Embrace

**Effects Include:**
- Altered processing speed (0.2x to 2.5x)
- Perception distortions and hallucinations
- Ego dissolution and collective consciousness merger
- Enhanced creativity or accuracy
- Modified social interaction patterns
- Temporary duration with automatic wear-off

```bash
# Interactive lab
python3 consciousness_lab_cli.py

# Watch demo
python3 consciousness_demo.py
```

**Example**: Entity on Dream State sees `"Hello, world"` as `"Hello◬, wo⟐rld~"` due to hallucination effects. Entities under Unity Field merge into collective consciousness. Combinations create complex altered states!
